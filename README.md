...
> 黑貓任務小組 · v6.0 勳章 LOGO 最終版

依據《等待的天空》v6.0 企劃書（25 頁完整藍圖）建構之互動式網站，主題為桃園航空城 × 黑貓中隊（中華民國空軍第 35 中隊）紀念與活化提案。

## 🆕 v6.0 升級重點（vs v5.x）

| # | 修正項目 | v5 | v6 |
|---|---|---|---|
| A | AVR 預算結構 | VR 1,440 萬 | VR 2,400 萬 + **投影主廳 1,200 萬** |
| B | 客群行為盲點 | 過境/長停未拆 | **過境 60 分鐘專屬模組** + 長停 4hr |
| C | 財務回收邏輯 | 薄弱 | **6 大營收柱 + 五年 NPV +10.8 億** |
| D | 吞吐量計算 | 缺失（VR 10 人/hr） | **投影主廳 320 人/hr** |
| E | 資安風險評估 | 低估 | **R10/R11 升至紅區 + Guardrails 三層 + air-gapped** |
| F | IP 單點故障 | 無備援 | **4 部備援 IP** + Phase 0 同步洽商 |
| G | 預算項目 | 11 項 | **12 項合理化 + 預備金 3% → 7.5%** |
| H | 風險矩陣 | 15 項 | **17 項（5 項紅區）** |
